...
### 1.1 Product Vision
Lanstellar is a blockchain-based platform that uses AI agents to verify real-world assets' ownership, history, market value, and legitimacy (RWA). The MVP will enable users to search for asset details using location or GPS coordinates, generate a unique contract address for each asset, and provide verified asset data to help investors make informed decisions.
...
#### Asset Search
Users can search for assets using:
- Location.
- GPS coordinates (latitude and longitude).
The system generates a unique contract address for each asset.

#### Unique Contract Address Generation
A hashing algorithm (e.g., SHA-256) converts location or GPS coordinates into unique contract addresses. These addresses are stored on the blockchain for transparency and immutability.
...
- **Pro Plan**: AI-powered insights, advanced fraud detection, and API access (e.g., booking.com, Airbnb, Agoda).
- **Enterprise Plan**: Bulk property verification, premium support, and early access to new features (e.g., booking.com, Airbnb, Agoda).
...
- Partner with asset marketplaces and blockchain projects for revenue-sharing agreements (e.g., booking.com, Airbnb, Agoda).
...
- **Transaction Volume**: 1,000+ transactions done on the platform.
...
## Open Questions
1. What are the most reliable data sources for asset information in Nigeria?
2. How can we ensure the AI models are trained on high-quality data?
3. What incentives can we offer to open-source contributors?
